...
RUN cd /src/payment-api-service;go clean -modcache;go get github.com/grpc-ecosystem/grpc-gateway/v2;go get gitlab.mapcard.pro/external-map-team/api-proto;go generate2;go build -o /app
