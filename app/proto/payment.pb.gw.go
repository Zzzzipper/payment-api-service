...
var (
	pattern_PaymentService_Block_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "block"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Charge_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "charge"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "get"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Init_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "init"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Pay_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "pay"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Payout_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "payout"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Refund_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "refund"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Void_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "void"}, "", runtime.AssumeColonVerbOpt(true)))
)
